...
initial_df = pd.read_csv('data/SP500_stock_prices.csv', delimiter=',')
...
# save model to file
save_path = 'svm_modelFullData.sav'
pickle.dump(model, open(save_path, 'wb'))
dump(model, 'svm_modelFullData.joblib')
print(f'Model saved to file: {save_path}')